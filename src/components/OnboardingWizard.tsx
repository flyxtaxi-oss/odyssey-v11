...
export default function OnboardingWizard() {
  ...
  return (
    <div role="dialog" aria-modal="true" aria-label="Assistant de configuration J.A.R.V.I.S." className="flex flex-col max-h-[80vh] w-full max-w-2xl mx-auto bg-slate-950 rounded-2xl overflow-hidden shadow-2xl border border-slate-800/50">
      {/* Header Premium */}
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6 scroll-smooth">
        ...
        {phase === "complete" && (
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className="w-full bg-gradient-to-br from-indigo-900/40 to-slate-900 border border-indigo-500/30 rounded-2xl p-6 shadow-xl">
